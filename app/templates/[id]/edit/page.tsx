...
interface FieldDefinition {
  ...
  name: string;
  type: string; // TODO: Update for Epic 3 - was FieldType
...
// TODO Story 3.X: Epic 3 removed template_type - this section needs redesign
...
// TODO Story 3.X: Epic 3 uses string types - update field type handling
...
export default function EditTemplatePage() {
  ...
  // TODO Story 3.X: Epic 3 removed template_type
  ...
  useEffect(() => {
    const loadTemplate = async () => {
      ...
      try {
        ...
        // TODO Story 3.X: Epic 3 removed template_type
        // setTemplateType(data.template.template_type as string);

        // Transform fields from database format to UI format
        // TODO Story 3.X: Update for Epic 3 schema (fields are now in JSONB)
        const transformedFields: FieldDefinition[] = (data.template.fields || []).map((f: any) => ({
          id: crypto.randomUUID(),
          name: f.name || f.field_name, // Epic 3 uses 'name', Epic 1 used 'field_name'
          type: (f.type || f.field_type || "text") as string,
  ...
  const addField = () => {
    const newField: FieldDefinition = {
      id: crypto.randomUUID(),
      name: "",
      type: "text", // TODO: Was FieldType.TEXT in Epic 1
      category: "header",
    };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        name: templateName,
        // template_type: templateType, // Removed in Epic 3
        fields: apiFields,
        ...(prompts && { prompts }),
      };
  ...
  return (
    <div className="container mx-auto py-10 px-4 max-w-4xl">
      ...
      <div className="space-y-6 mb-8">
        ...
        {/* TODO Story 3.X: Epic 3 removed template_type - This UI section commented out */}
        {/* Template Type */}
        {/* <div className="space-y-2">
          ...
          <Select
            value={templateType}
            onValueChange={(value) => setTemplateType(value as string)}
            disabled={isLoading}
          >
